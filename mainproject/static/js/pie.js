    ...
    inherits: AmCharts.AmSlicedChart, construct: function (e) {
        ...
        if (AmCharts.ifArray(e)) {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.realHeight = h;
                var d = AmCharts.toCoordinate, k = d(this.marginLeft, a), b = d(this.marginRight, a),
                    q = d(this.marginTop, h) + this.getTitleHeight(), l = d(this.marginBottom, h), u, v, f,
                ...
                for (k = 0; k < e.length; k++) if (b = e[k], !0 !== b.hidden && 0 < b.percents) {
                    var m = 360 * b.percents / 100, r = Math.sin((l + m / 2) / 180 * Math.PI),
                        w = -Math.cos((l + m / 2) / 180 * Math.PI) * (a / f), p = this.outlineColor;
                    p || (p = b.color);
                    p = {
                        fill: b.color,
                        stroke: p,
                    ...
                    if (this.labelsEnabled && this.labelText && b.percents >= this.hideLabelsPercent) {
                        ...
                        var n = this.formatString(this.labelText,
                            b), A = b.labelColor;
                        A || (A = this.color);
        ...
        if (l) {
            if (!0 === a) for (k = e + 1; k < q; k++) b[k].labelQuarter == c && (d = this.checkOverlappingReal(g,
                b[k], c)) && (k = q); else for (k = e - 1; 0 <= k; k--) b[k].labelQuarter == c && (d = this.checkOverlappingReal(g, b[k], c)) && (k = 0);
