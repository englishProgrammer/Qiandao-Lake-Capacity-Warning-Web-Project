AmCharts.AmSerialChart = AmCharts.Class({
    inherits: AmCharts.AmRectangularChart, construct: function (a) {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if (b.parseDates && !b.equalSpacing) {
                    if (b = this.startTime, c = this.endTime,
                    isNaN(b) || isNaN(c)) b = this.firstTime, c = this.lastTime
        ...
        c.parseDates && !c.equalSpacing ?
            this.timeZoom(a, b) : this.indexZoom(a, b);
    ...
    updateGraphs: function () {
        ...
        for (n = 0; n < b; n++) {
            e = this.valueAxes[n];
            var l = e.stackType;
            if ("100%" == l || "regular" == l) for (g = !1, k = 0; k < c; k++) d = this.graphs[k], d.hidden || d.valueAxis != e || "column" != d.type || (!g && d.stackable && (a++, g = !0), !d.stackable && d.clustered && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
            if ("none" == l || "3d" == l) for (k = 0; k < c; k++) d = this.graphs[k], !d.hidden &&
            d.valueAxis == e && "column" == d.type && d.clustered && (d.columnIndex = a, a++);
            if ("3d" == l) {
    ...
    getClosestIndex: function (a, b, c, d, e, g) {
        ...
        var k = e + Math.round((g - e) / 2), n = a[k][b];
        if (1 >= g - e) {
            if (d) return e;
            d = a[g][b];
        ...
        if (c) {
            var d = c.length;
            0 < d && (0 > a && (a = 0), b > d - 1 && (b = d - 1), d = this.categoryAxis, d.parseDates && !d.equalSpacing ? this.zoom(c[a].time, this.getEndTime(c[b].time)) :
                this.zoom(a, b))
        }
        ...
        if (b) {
            var c = ["value", "open", "low",
                    "high", "close"], d = "value open low high close average sum count".split(" "), e = b.valueAxis,
                g = this.chartData, k = b.numberFormatter;
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                ...
                -1 != a.indexOf("[[category]]") && (g = AmCharts.formatDate(e, g), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, e)), e = g)
            }
        ...
        e = b.graph.valueAxis;
        (g = e.duration) && !isNaN(b.values.value) && (e = AmCharts.formatDuration(b.values.value, g, "", e.durationUnits, e.maxInterval, d), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), e));
...
AmCharts.Cuboid = AmCharts.Class({
    construct: function (a, b, c, d, e, g, k, n, l, h, f, m, u, p, s) {
        ...
        var b = this.container, c = this.w, d = this.h, e = this.dx, g =
                this.dy, k = this.colors, n = this.alpha, l = this.bwidth, h = this.bcolor, f = this.balpha,
            m = this.gradientRotation, u = this.cornerRadius, p = this.dashLength, s = this.pattern, y = k, w = k;
        "object" == typeof k && (y = k[0], w = k[k.length - 1]);
        var r, q, t, v, z, B, A, x, C, D = n;
        s && (n = 0);
        if (0 < e || 0 < g) A = w, w = AmCharts.adjustLuminosity(y, -0.2), w = AmCharts.adjustLuminosity(y, -0.2), r = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, g, g, 0, 0], w, n, 1, h, 0, m), 0 < f && (C = AmCharts.line(b, [0, e, c + e], [0, g, g], h, f, l, p)), q = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], w, n, 1, h, 0, m), q.translate(e,
        ...
        1 > Math.abs(d) && (d = 0);
        1 > Math.abs(c) && (c = 0);
        b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], h, f, l, p) : 0 === c ? AmCharts.line(b,
            [0, 0], [0, d], h, f, l, p) : 0 < u ? AmCharts.rect(b, c, d, k, n, l, h, f, u, m, p) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], k, n, l, h, f, m, !1, p);
...
AmCharts.CategoryAxis = AmCharts.Class({
    inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            b = this.end - d + 1;
            var k = this.gridCountR, n = this.showFirstLabel, l = this.showLastLabel, h, f = "",
                m = AmCharts.extractPeriod(this.minPeriod);
            h = AmCharts.getPeriodDuration(m.period, m.count);
            var u, p, s, y, w;
            u = this.rotate;
            var r = this.firstDayOfWeek, q = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length -
            1].time + 1.05 * h), this.minPeriod, 1, r).getTime(), t;
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                var k = Math.ceil(this.timeDifference / p) + 5,
                    B = f = AmCharts.resetDateToMin(new Date(this.startTime - p), e,
                        u, r).getTime();
                ...
                if (0 < this.gridCountR) for (b = d; b <= k; b++) {
                    ...
                    "MM" == e && (t = (m - f) / p, 1.5 <= (m - f) / p && (m = m - (t - 1) * p + AmCharts.getPeriodDuration("DD", 3), m = AmCharts.resetDateToMin(new Date(m),
                        e, 1).getTime(), x += p));
                    ...
                    this.pushAxisItem(f);
                    f = m;
                    if (!isNaN(v)) for (h = 1; h < u; h += v) this.gridAlpha =
                        this.minorGridAlpha, t = m + z * h, t = AmCharts.resetDateToMin(new Date(t), e, v, r).getTime(), t = new this.axisItemRenderer(this, (t - this.startTime) * this.stepWidth), this.pushAxisItem(t);
                    this.gridAlpha = a
                }
                ...
                if (this.cellWidth = this.getStepWidth(b), b < k && (k = b), g += this.start, this.stepWidth = this.getStepWidth(b), 0 < k) for (q = Math.floor(b / k), v = this.chooseMinorFrequency(q), h = g, h / 2 == Math.round(h / 2) && h--, 0 > h && (h = 0), k = 0, b = h; b <= this.end + 2; b++) {
                    r = !1;
                    0 <= b && b < this.data.length ? (s = this.data[b], f = s.category, r =
                        s.forceShow) : f = "";
                    if (t && !isNaN(v)) if (b / v == Math.round(b / v) || r) b / q == Math.round(b / q) || r || (this.gridAlpha = this.minorGridAlpha, f = void 0); else continue; else if (b / q != Math.round(b / q) && !r) continue;
                ...
                f = AmCharts.resetDateToMin(new Date(this.startTime -
                    p), e, u, r).getTime();
                ...
                p = h;
                if (this.data[h].time != AmCharts.resetDateToMin(new Date(this.data[h].time), e, u, r).getTime()) for (r = 0, A = f, b = h; b < y; b++) m = this.data[b].time, this.checkPeriodChange(e, u, m, A) && (r++, 2 <= r && (p = b, b = y), A = m);
                t && 1 < u &&
                (v = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, v));
                for (b = h; b < y; b++) if (m = this.data[b].time, this.checkPeriodChange(e, u, m, f) && b >= p) {
                    ...
                    f = AmCharts.formatDate(new Date(m), f);
                    if (b == d && !n || b == k && !l) f = " ";
                    z ? z = !1 : (q || (t = !1), h - this.previousPos > this.safeDistance * Math.cos(this.labelRotation *
                        Math.PI / 180) && (this.labelFunction && (f = this.labelFunction(f, new Date(m), this)), f = new this.axisItemRenderer(this, h, f, void 0, void 0, void 0, void 0, t), r = f.graphics(), this.pushAxisItem(f), r = r.getBBox().width, AmCharts.isModern || (r -= h), this.previousPos = h + r));
                    f = m
                } else isNaN(v) || (this.checkPeriodChange(e, v, m, B) && (this.gridAlpha = this.minorGridAlpha, h = this.getCoordinate(b - this.start), t = new this.axisItemRenderer(this, h), this.pushAxisItem(t), B = m), this.gridAlpha = a)
            }
            for (b = 0; b < this.data.length; b++) if (n = this.data[b]) l =
                this.parseDates && !this.equalSpacing ? Math.round((n.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), n.x[this.id] = l;
            n = this.guides.length;
            for (b = 0; b < n; b++) l = this.guides[b], q = q = q = a = d = NaN, v = l.above, l.toCategory && (q = c.getCategoryIndexByValue(l.toCategory), isNaN(q) || (d = this.getCoordinate(q - g), f = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(f, v))), l.category && (q = c.getCategoryIndexByValue(l.category), isNaN(q) || (a = this.getCoordinate(q - g), q = (d - a) / 2, f = new this.axisItemRenderer(this,
        ...
        this.autoWrap && !this.parseDates && (this.axisCreated = this.chart.marginsUpdated = !1);
        ...
        var b;
        this.startOnAxis ?
            (b = this.axisWidth / (a - 1), 1 == a && (b = this.axisWidth)) : b = this.axisWidth / a;
        return b
        ...
        c = new Date(c);
        var g = new Date(d), k = this.firstDayOfWeek;
        d = b;
        "DD" == a && (b = 1);
        c = AmCharts.resetDateToMin(c,
            a, b, k).getTime();
        ...
        this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(a / e) - this.minDuration() / 2, c = c.getClosestIndex(b, "time",
            a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= e / 2), c = this.start + Math.round(a / e));
