    ...
    inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if (c.valueAxis == this) {
                ...
                var e, f, g = this.end + 2, g = AmCharts.fitToBounds(this.end + 1, 0, this.data.length - 1),
                    h = this.start;
                0 < h && h--;
                var k;
                f = this.start;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l) {
        ...
        this.set = u;
        var q = a.axisThickness, t = a.axisColor, v = a.axisAlpha, s = a.tickLength, w = a.gridAlpha,
            A = a.gridThickness, C = a.gridColor, y = a.dashLength, z = a.fillColor, J = a.fillAlpha,
            I = a.labelsEnabled, B = a.labelRotation, Z = a.counter, S = a.inside,
            da = a.dx, X = a.dy, Fa = a.orientation, ea = a.position, $ = a.previousCoord, L = a.viH, V = a.viW,
            oa = a.offset, Y, W;
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.chart, b = this.id, c = this.index, d = this.data, e = this.chart.container, f = this.valueAxis,
            g = this.type, h = this.columnWidthReal;
        ...
        var k = this.width, l = this.height, m = this.y, n = this.rotate, p = this.columnCount,
            ...
            C = this.chart.graphs.length, y, z = this.dx / this.depthCount, J = this.dy / this.depthCount,
            I = f.stackType, B = this.labelPosition, Z = this.start, S = this.end, da = this.scrollbar,
            X = this.categoryAxis, Fa = this.baseCoord, ea = this.negativeBase, $ = this.columnIndex,
            L = this.lineThickness, V = this.lineAlpha, oa = this.lineColorR, Y = this.dashLength, W = this.set, aa = B,
            ha = this.getGradRotation(), G = this.chart.columnSpacing, D = X.cellWidth, ia = (D * h - p) / p;
        G > ia && (G = ia);
        var P, x, Va, ab = l + 1, bb = k + 1, Wa = 0, cb = 0, db, eb, Xa, Ya, Kb = this.fillColorsR,
            Ka = this.negativeFillColors, Aa = this.negativeLineColor, La = this.fillAlphas,
        ...
        for (H = Z; H <= S; H++) {
            ...
            x.index = H;
            var M, N, K, ba, ja = NaN, F = NaN, E = NaN, Q = NaN, O = NaN, Oa = NaN, Ba = NaN, Pa = NaN, Ca = NaN,
                ca = NaN, ga = NaN, pa = NaN, qa = NaN, R = NaN, fb = NaN, gb = NaN, la = NaN, na = void 0, za = Kb,
                Qa = La, ra = oa, ma, sa, Ra = this.pattern;
            ...
            if (ta) {
                ...
                var ja = P.x[X.id], Ha = this.periodSpan - 1, ka = Math.floor(D / 2) + Math.floor(Ha * D / 2), ua = ka,
                    wb = 0;
                    ...
                    case "ohlc":
                        if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
                            ...
                            if (n) {
                                ...
                                var sb = F - h / 2, sb = AmCharts.fitToBounds(sb, 0, k),
                                    Ab = AmCharts.fitToBounds(F, 0, k), tb = F + h / 2,
                ...
                if (!da && !isNaN(R)) {
                    ...
                    if (this.end - this.start <= Bb || 0 === Bb) {
                        ...
                        if (Cb) {
                            var fa = this.createLabel(x, 0, 0, Cb), va = 0, wa = 0, Db = fa.getBBox(), Ia = Db.width,
                                Ea = Db.height;
                            switch (B) {
                                case "left":
                                    va = -(Ia / 2 + Da / 2 + 3);
        ...
        if (1 < a.length) {
            ...
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n =
                    this.lineColorR, p = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors,
                q = this.negativeFillAlphas, t = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
        ...
        e = this.bullet;
        a.bullet && (e = a.bullet);
        var g = this.bulletBorderThickness, n = this.bulletBorderColorR, p = this.bulletBorderAlpha,
            r = this.bulletAlpha;
        n || (n = l);
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness,
            g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, n = this.x, p = this.y, r = this.width, u = this.height,
            a = a.rotate, q = c.tickLength;
        g.pointerWidth = q;
        ...
        var a = this.cursorAlpha, b = this.container, c = AmCharts.line(b,
            [0, 0], [0, this.height], this.cursorColor, a, 1),
        ...
        if (this.enabled) {
            ...
            var f = c.categoryAxis, g = c.dx, h = c.dy, k = this.x, l = this.y, m = this.width, n = this.height,
                p = this.data[a];
            this.fireMoved();
            if (p) {
                var r = p.x[f.id], u = c.rotate, q = f.inside, t = this.stepWidth, v = this.categoryBalloon,
                    s = this.firstTime, w = this.lastTime, A = this.cursorPosition, C = f.position, y = this.zooming,
                    z = this.panning, J = c.graphs, I = f.axisThickness;
                if (c.mouseIsOver || y || z || this.forceShow) if (this.forceShow = !1, z) {
                    var g = this.panClickPos, c = this.panClickEndTime, y = this.panClickStartTime,
                        B = this.panClickEnd, k = this.panClickStart, d = (u ? g - e : g - d) / t;
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    construct: function (a) {
        ...
        c = h.x + e;
        d = h.y + f;
        var k = h.width, h = h.height, l = this.rotate, m = this.chart, n = this.width, p = this.height, r = m.mouseX,
            u = m.mouseY;
        a = this.initialMouse;
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor, n = this.fillColor,
                    p = this.borderColor, r = n;
                void 0 != m && (this.adjustBorderColor ? r = p = m : n = m);
                var u = this.horizontalPadding, q = this.verticalPadding, t = this.pointerWidth,
                    v = this.pointerOrientation, s = this.cornerRadius, w = c.fontFamily, A = this.fontSize;
                ...
                A < g && (A = g);
                A + y > k && (A = k - y);
                var h = z + q, l = A + u, q = this.shadowAlpha, I = this.shadowColor, u = this.borderThickness,
                    B = this.bulletSize, Z;
...
AmCharts.AmRectangularChart = AmCharts.Class({
    inherits: AmCharts.AmCoordinateChart, construct: function (a) {
        ...
        var a = this.valueAxes, b, c = this.autoMarginOffset, d = this.fixMargins, e = this.realWidth,
            f = this.realHeight, g = c, h = c, k = e - c;
        b = f - c;
        var l;
...
AmCharts.TrendLine = AmCharts.Class({
    construct: function (a) {
        ...
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory,
            m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, u = a.initialXValue,
            q = a.finalXValue, t = a.initialValue, v = a.finalValue,
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    var t = 1 / 180 * Math.PI, q = b + Math.sin(d * t) * h, v = c - Math.cos(d * t) * r, s = b + Math.sin(d * t) * f,
        ...
        z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]},
        J = 0;
    180 < Math.abs(e) && (J = 1);
    d = a.set();
    var I;
...
AmCharts.Bezier = AmCharts.Class({
    ...
    interpolate: function (a) {
        ...
        var e = Math.round, f = this.getPointOnSegment(a, b, 0.75), g = this.getPointOnSegment(d, c, 0.75),
            h = (d.x - a.x) / 16, k = (d.y - a.y) / 16, l = this.getPointOnSegment(a, b, 0.375);
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop,
            ...
            l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, r = 0, u = this.container, q = u.set();
        this.set = q;
        u = u.set();
        q.push(u);
